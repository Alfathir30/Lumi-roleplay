...
const _ = class _ {
  ...
  async init() {
    const { createPiperPhonemize: e } = await import("https://user.uploads.dev/file/b63081b27fa7f90060922e4fbd3630b4.js");
    u(this, U, e), u(this, r, await import("https://esm.sh/onnxruntime-web@1.18.0")), o(this, r).env.allowLocalModels = !1, o(this, r).env.wasm.numThreads = navigator.hardwareConcurrency, o(this, r).env.wasm.wasmPaths = o(this, h).onnxWasm;
  ...
  async predict(e, OV2) {
    ...
    }), OV = OV2 || this.__scales || {}, a = 0, t = o(this, l).audio.sample_rate, s = OV.noise_scale ?? o(this, l).inference.noise_scale, d = OV.length_scale ?? o(this, l).inference.length_scale, x = OV.noise_w ?? o(this, l).inference.noise_w, k = o(this, g), B = {
...
async function V() {
  try {
    ...
    const n = await import("https://user.uploads.dev/file/851db98f09f836d4311b26597e486ba7.js");
